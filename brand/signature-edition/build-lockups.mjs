...
const master = mark("symbol-master.svg");
const compact = mark("symbol-compact.svg");
...
writeFileSync(
  join(out, "logo-horizontal-compact.svg"),
...
console.log("signature lockups built");
